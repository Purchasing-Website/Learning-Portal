...
<body id="page-top">
    <div id="wrapper">
        <nav class="navbar bg-dark align-items-start p-0 sidebar sidebar-dark accordion bg-gradient-primary navbar-dark" style="--bs-primary: #131318;--bs-primary-rgb: 19,19,24;color: rgb(24,24,25);background: var(--bs-black);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center m-0 sidebar-brand" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route('lesson.index','all') }}"><i class="fas fa-book" style="margin-right: 0px;text-align: center;width: 20px;"></i><span style="padding: 0px 4px;">Lesson</span></a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route('logout') }}"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-logout" style="width: 20px;height: 14px;text-align: center;">
        ...
        <div class="d-flex flex-column" id="content-wrapper" style="margin: -1px;">
            <div id="content">
                <nav class="navbar navbar-expand bg-dark shadow topbar static-top navbar-light" style="margin-bottom: 12px;">
