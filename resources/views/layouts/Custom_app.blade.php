        ...
        <nav class="navbar bg-dark align-items-start p-0 sidebar sidebar-dark accordion bg-gradient-primary navbar-dark" style="--bs-primary: #131318;--bs-primary-rgb: 19,19,24;color: rgb(24,24,25);background: var(--bs-black);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center m-0 sidebar-brand" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item"><a class="nav-link" href="Dashboard.html"><i class="fas fa-tachometer-alt" style="margin: 0px;width: 20px;text-align: center;"></i><span style="padding: 0px 4px;">Dashboard</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="User%20List.html"><i class="fas fa-user" style="width: 20px;height: 20px;margin-right: 0px;text-align: center;"></i><span style="padding: 0px 4px;">User</span></a><a class="nav-link" href="Program.html"><i class="fas fa-user-graduate" style="margin-right: 0px;width: 20px;text-align: center;"></i><span style="padding: 0px 4px;">Program</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="AdminPayment.html"><i class="fas fa-book-reader" style="width: 20px;height: 14px;margin: 0px;text-align: center;"></i><span style="padding: 0px 4px;">Course</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="Staff%20List.html"><i class="fas fa-users" style="margin-right: 0px;width: 20px;text-align: center;"></i><span style="padding: 0px 4px;">Class</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="Inventory%20List.html"><i class="fas fa-book" style="margin-right: 0px;text-align: center;width: 20px;"></i><span style="padding: 0px 4px;">Lesson</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="ProductManagement.html"><i class="fas fa-lightbulb" style="width: 20px;height: 20px;margin: 0px;text-align: center;"></i><span style="padding: 0px 4px;">Quiz</span></a></li>
                    <li class="nav-item"></li>
                    <li class="nav-item"><a class="nav-link" href="LoginPage_Admin.html"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-logout" style="width: 20px;height: 14px;text-align: center;">
