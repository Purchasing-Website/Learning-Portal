        ...
        <div class="card-wrap">
            <div class="card login-card">
                <div class="card-body">
                    ...
                    <form id="forgotPasswordForm" action="verification_link_sent.blade.php" method="get" novalidate>
                        <div class="position-relative mb-4">
                            ...
                            <input class="form-control" type="email" id="email" name="email" placeholder="Confirm your email" autocomplete="email" required>
                        ...
                        <button class="btn fw-semibold w-100 btn-gradient text-white" type="submit">Send Verification Link</button>
                    </form>
                </div>
            </div>
        </div>
