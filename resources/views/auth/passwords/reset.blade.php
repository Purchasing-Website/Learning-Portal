    ...
    <main class="position-relative d-flex min-vh-100 justify-content-center align-items-center px-3">
        <div class="card-wrap">
                ...
                <div class="card-body">
                    ...
                    <form id="loginForm" method="POST" action="{{ route('password.update') }}" novalidate>
						...
						<div class="position-relative mb-4">
                            ...
                            <input class="form-control @error('email') is-invalid @enderror" id="email" type="email" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" readonly>
                        ...
                        <button class="btn fw-semibold w-100 btn-gradient text-white mt-3" type="submit">Reset Password</button>
                    </form>
                </div>
            </div>
        </div>
